...
from pysad_rust import HalfSpaceTrees
...
def run_hst(dataset_name, run_count=None, seed=42, progress_interval=1000, output_dir="benchmark_results", verbose=True):
    """Run Half-Space Trees algorithm on a dataset."""
    ...
    try:
        ...
        print(f"HST completed on {dataset_name}")
